-- Migration: Authentication Tokens
-- תבלת טוקנים לאיפוס סיסמה ואימות אימייל
...
create index if not exists auth_tokens_teacher_id_idx on public.auth_tokens(teacher_id);
